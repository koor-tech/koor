...
An object store bucket is a container holding immutable objects. The Rook-Ceph [operator](https://github.com/koor-tech/koor/blob/master/deploy/examples/operator.yaml) creates a controller which automates the provisioning of new and existing buckets.
